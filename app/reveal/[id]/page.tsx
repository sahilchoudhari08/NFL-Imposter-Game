      ...
      {!revealed ? (
        ...
        <div className="w-full h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 text-gray-900 transition-all duration-500 animate-fade-in fixed inset-0">
          <div className="text-center space-y-8 max-w-md w-full px-4">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6 animate-scale-in">
              {role.isImposter ? (
                ...
                <div className="space-y-4">
                  <p className="text-xl text-gray-600 mb-2">Your player is:</p>
            ...
            <button
              onClick={handleNext}
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-6 rounded-xl text-lg transition-all duration-200 transform hover:scale-105 active:scale-95 shadow-md mt-8"
            >
